...
impl Instruction {
    ...
    fn decode_cb_helper(first_opcode: u8, opcode: u8) -> (Arg, u8) {
        ...
        let arg = if lower < 0x8 { lower } else { lower - 0x8 };
